...
echo '<div class="head" style="padding: 3px;">';
...
<a href="/user_'.$user['id'].'" style="margin: 0px;">Профиль</a>
<a href="/user/red_ank.php" style="margin: 0px;">Редактировать профиль</a>
<a href="/user/us/up-level.php" style="margin: 0px;">Повышение прав</a>
<a href="/user/settings.php" style="margin: 0px;">Настройки</a>
<a href="/user/allcoin.php" style="margin: 0px;">AllCoins</a>
<a href="/user.php" style="margin: 0px;">Люди</a>
<a href="#help" style="margin: 0px;">Помощь</a>
<a href="#exit" style="margin: 0px; color: #ea4c3e;">Выход</a>';
