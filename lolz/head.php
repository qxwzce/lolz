...
<meta property="og:title" content="HackLair - Форум социальной инженерии">
...
<a href="/user/red_ank.php" style="margin: 0px;">Редактировать профиль<span class="icon-menu"><i class="fas fa-user"></i></span></a>
<a href="/user/us/up-level.php" style="margin: 0px;">Повышение прав<span class="icon-menu"><i class="fas fa-user"></i></span></a>
<a href="/user/settings.php" style="margin: 0px;">Настройки<span class="icon-menu"><i class="fas fa-user"></i></span></a>
<a href="/user/allcoin.php" style="margin: 0px;">AllCoins<span class="icon-menu"><i class="fas fa-user"></i></span></a>
<a href="/user.php" style="margin: 0px;">Люди<span class="icon-menu"><i class="fas fa-user"></i></span></a>
<a href="#help" style="margin: 0px;">Помощь<span class="icon-menu"><i class="fas fa-user"></i></span></a>
<a href="#exit" style="margin: 0px; color: #ea4c3e;">Выход<span class="icon-menu"><i class="fas fa-user"></i></span></a>';
